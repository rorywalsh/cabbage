...
rslider    bounds(  0, 25, 90, 90), textbox(1), text("Breath"),     channel("amp"),      range(0.001,10,1,0.5),        $SLIDER_STYLE
...
rslider    bounds(505, 25, 90, 90), textbox(1), text("Stereo"),   channel("Stereo"),   range(0,1,1),                 $SLIDER_STYLE
...
rslider    bounds(885, 25, 90, 90), textbox(1), text("Level"),    channel("outamp"),   range(0.001,100,3,0.5,0.001), $SLIDER_STYLE
