...
gentable outlinethickness(1), bounds(  0,  0, 610,300), tablenumber(1), tablebackgroundcolour("white"), tablegridcolour("WhiteSmoke"), tablecolour("black"), identchannel("ampFFT"), amprange(0,1,-1), samplerange(0, 512) 
