...
image bounds(  5,  0,250, 210), colour(255,255, 50,100),shape("rounded"), outlineColour("white"), line(0)
image bounds(255,  0,250, 210), colour(  0,  0,255,100),shape("rounded"), outlineColour("white"), line(0)
image bounds(  5,210,250, 210), colour(  5,255,  0,100),shape("rounded"), outlineColour("white"), line(0)
image bounds(255,210,250, 210), colour(255,  0,200,100),shape("rounded"), outlineColour("white"), line(0)
