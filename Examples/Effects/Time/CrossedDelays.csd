...
rslider  bounds( 75, 20, 90, 90), text("Tempo"), channel("Tempo"), textbox(1), range(20,500,60,1,0.1)
rslider  bounds(140, 20, 90, 90), text("Mix"), channel("Mix"), textbox(1), range(0,1,0.5,1,0.01)
rslider  bounds(205, 20, 90, 90), text("Feedback"), channel("Feedback"), textbox(1), range(0,3,0.5,1,0.01)
...
rslider  bounds( 75, 20, 90, 90), text("Freq.1"), channel("Freq1"), textbox(1), range(-6000,6000,200,1,1)
rslider  bounds(140, 20, 90, 90), text("Freq.2"), channel("Freq2"), textbox(1), range(-6000,6000,333,1,1)
}
...
rslider  bounds(-10, 20, 90, 90), text("Pan 1"), channel("Pan1"), textbox(1), range(0,1,0)
rslider  bounds( 55, 20, 90, 90), text("Pan 2"), channel("Pan2"), textbox(1), range(0,1,1)
rslider  bounds(120, 20, 90, 90), text("Level"), channel("Level"), textbox(1), range(0,1,1)
}
