...
<Cabbage>
form             size(525,100), caption("clip"), pluginId("Clip")
...
gentable bounds(405, 10,100, 70), tableNumber(1000), identChannel("TF"), ampRange(-1.1,1.1,1000), tableColour(150,160,220)
