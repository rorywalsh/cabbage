...
<Cabbage>
form size(230, 120), caption("Lo Fi"), pluginid("lofi"), scrollbars(0) style("legacy") style("legacy")
...
<Cabbage>
form caption("pdclip") size(380, 90), pluginid("pdcl") style("legacy") style("legacy")
...
<Cabbage>
form caption("Powershape") size(300,160), pluginid("pshp") style("legacy") style("legacy")
...
form caption("Compressor") size(440,130), pluginid("Comp") style("legacy") style("legacy")
...
<Cabbage>
form caption("Compressor/Expander") size(890, 100), pluginid("CoEx") style("legacy") style("legacy")
...
<Cabbage>
form caption("Exciter") size(445, 100), pluginid("Ectr") style("legacy") style("legacy")
...
<Cabbage>                                                                                                                   
form caption("Gate"), colour( 20, 20, 30), size(430, 305), pluginid("Gate"), scrollbars(0) style("legacy") style("legacy")
...
form caption("Limiter") size(435,105), pluginid("lmtr") style("legacy") style("legacy")
...
<Cabbage>
form caption("Band Filter"), colour(10,10,10), size(470, 360), pluginid("BdFl") style("legacy") style("legacy")
...
<Cabbage>                                                                                                                   
form caption("Bandfilter II"), colour("LightSlateGrey"), size(510, 655), pluginid("BFII"), scrollbars(0) style("legacy") style("legacy")
...
<Cabbage>
form caption("clfilt - Multi-Mode Filter") size(655, 90), pluginid("clfl"), scrollbars(0) style("legacy") style("legacy")
...
<Cabbage>
form caption("Envelope Follower") size(530, 100), pluginid("envf") style("legacy") style("legacy")
...
<Cabbage>
form caption("Filter LFO") size(790,170), pluginid("FLFO") style("legacy") style("legacy")
...
<Cabbage>
form caption("Filter Shaper") size(595, 200), pluginid("FlSh") style("legacy") style("legacy")
...
<Cabbage>
form caption("Formant Filter"), colour("SlateGrey"), size(550, 280), pluginid("form")   style("legacy") style("legacy")
...
<Cabbage>
form caption("Harp Filter") size(1080,205), pluginid("HaFi") style("legacy") style("legacy")
...
<Cabbage>
form caption("Highpass Filter"), size(435, 90), pluginid("HPFl") style("legacy") style("legacy")
...
<Cabbage>
form caption("Lowpass Filter") size(435, 90), pluginid("LPFl") style("legacy") style("legacy")
...
<Cabbage>
form caption("phaser1") size(400, 90), pluginid("phs1") style("legacy") style("legacy")
...
<Cabbage>
form caption("phaser2") size(685, 90), pluginid("phs2") style("legacy") style("legacy")
...
<Cabbage>
form caption("resony") size(750,180), pluginid("rsny"), colour(255,100,0) style("legacy") style("legacy")
...
<Cabbage>
form caption("vocoder"), size(530, 230), pluginid("voco") style("legacy") style("legacy")
...
<Cabbage>
form caption("wguide1") size(650,200), pluginid("WGu1"), scrollbars(0) style("legacy") style("legacy")
...
<Cabbage>
form caption("wguide2") size(595, 90), pluginid("WGu2") style("legacy") style("legacy")
...
<Cabbage>
form caption("Autopan / Tremolo") size(565, 102), pluginid("aptr"), guirefresh(32) style("legacy") style("legacy")
...
<Cabbage>
form caption("-oOo-"), size(610, 180), pluginid("dopp")   style("legacy") style("legacy")
...
<Cabbage>
form caption("Doppler Spin"), size(700,265), pluginid("SDop") style("legacy") style("legacy")
...
<Cabbage>
form caption("Flanger") size(510,100), pluginid("flan") style("legacy") style("legacy")
...
<Cabbage>
form caption("Leslie Speaker") size(260,120), pluginid("Lsli") style("legacy") style("legacy")
...
<Cabbage>
form caption("Phaser LFO") size(580, 95), pluginid("phsr") style("legacy") style("legacy")
...
<Cabbage>
form caption("Stereo Chorus") size(595, 100), pluginid("StCh") style("legacy") style("legacy")
...
<Cabbage>
form caption("Ball in a Box") size(800,395), pluginid("BABO"), colour(100,100,120) style("legacy") style("legacy")
...
<Cabbage>
form caption("Convolution Reverb") size(505,230), pluginid("Conv") style("legacy") style("legacy")
...
<Cabbage>
form caption("Distance Emulator") size(700,300), colour(200,210,180), pluginid("DsEm") style("legacy") style("legacy")
...
<Cabbage>
form caption("Gate Reverb"), size(850, 85), pluginid("GtRv"), colour(13, 50, 67,50) style("legacy") style("legacy")
...
<Cabbage>
form caption("Multi Reverb") size(415, 90), pluginid("Rvrb") style("legacy") style("legacy")
...
<Cabbage>
form caption("Buffer Freeze"), size(610, 250), pluginid("BfFr"), colour(50,50,75) style("legacy") style("legacy")
...
<Cabbage>
form caption("Frequency Shifter") size(560,180), pluginid("fshi") style("legacy") style("legacy")
...
<Cabbage>
form caption("Pitch Shifter") size(840,  90), pluginid("PShf"), scrollbars(0) style("legacy") style("legacy")
...
<Cabbage>
form caption("pvsAdsyn") size(580, 90), pluginid("adsy") style("legacy") style("legacy")
...
<Cabbage>
form caption("pvsBlur"), size(235,125) colour( 70, 90,100), pluginid("blur") style("legacy") style("legacy")
...
<Cabbage>
form caption("pvsBuffer") size(580,135), pluginid("buff") style("legacy") style("legacy")
...
<Cabbage>
form caption("pvscale Pitch Shifter") size(690,  90), pluginid("scal") style("legacy") style("legacy")
...
<Cabbage>
form caption("pvsCross") size(370, 90), pluginid("crss") style("legacy") style("legacy")
...
<Cabbage>
form caption("pvsfreeze"), size(660,100) colour(  0,160,80), pluginid("frez") style("legacy") style("legacy")
...
<Cabbage>
form caption("pvshift Frequency Shifter") size(510,  90), pluginid("shft"), scrollbars(0) style("legacy") style("legacy")
...
<Cabbage>
form caption("pvSmooth") size(505, 90), pluginid("smoo"), scrollbars(0) style("legacy") style("legacy")
...
<Cabbage>
form caption("pvsWarp") size(535, 90), pluginid("warp") style("legacy") style("legacy")
...
<Cabbage>
form caption("Ring Modulator") size(755,170), pluginid("rmod") style("legacy") style("legacy")
...
<Cabbage>
form caption("") size(460,395), colour(225,230,255), pluginid("Shrd"), scrollbars(0) style("legacy") style("legacy")
...
<Cabbage>
form caption("Bounce Delay"), size(490,385), pluginid("BnDl") style("legacy") style("legacy")
...
<Cabbage>
form          size(440,470), caption("Break Beat Cutter"), pluginid("bbct") style("legacy") style("legacy")
...
<Cabbage>
form caption("Crossed Delays") size(815, 130), pluginid("CrDl") style("legacy") style("legacy")
...
<Cabbage>
form caption("Delay Grain") size(410, 520), pluginid("DGrn") style("legacy") style("legacy")
...
<Cabbage>
form caption("Live Sndwarp") size(530, 495), pluginid("lwrp") style("legacy") style("legacy")
...
<Cabbage>
form size(960, 260), caption("Modulating Delays"), pluginid("mdel") style("legacy") style("legacy")
...
<Cabbage>
form caption("Multi-mode Delay") size(435, 90), pluginid("MMDl") style("legacy") style("legacy")
...
<Cabbage>
form caption("Multitap Delay") size(300,385), pluginid("MtDl") style("legacy") style("legacy")
...
<Cabbage>
form caption("Peeaaoooh") size(650,207), pluginid("Peao") style("legacy") style("legacy")
...
<Cabbage>
form caption("Reverse") size(455, 95), pluginid("rvrs") style("legacy") style("legacy")
...
<Cabbage>
form caption("") size(530,345), colour("black"), pluginid("SpDl") style("legacy") style("legacy")
...
form caption("Stuck Buffer") size(600,110), colour(50,50,50), pluginid("StBu") style("legacy") style("legacy")
...
<Cabbage>
form caption("Tempo Delay") size(565, 90), pluginid("TpDl") style("legacy") style("legacy")
...
<Cabbage>
form caption("Time Slip"), size(700,210), pluginid("TmSl") style("legacy") style("legacy")
...
<Cabbage>
form caption("Trigger Delay") size(540,240), pluginid("TrDl") style("legacy") style("legacy")
...
<Cabbage>
form caption("waveset") size(510, 90), pluginid("wset") style("legacy") style("legacy")
...
<Cabbage>
form caption("Diskin File Player") size(1025, 310), pluginid("DkPl") style("legacy") style("legacy")
...
<Cabbage>
form caption("File Recorder") size(230, 45), colour(0,0,0) pluginid("FRec") style("legacy") style("legacy")
...
<Cabbage>
form caption("File Stretcher") size(580,430), colour(0,0,0) pluginid("FiSt"), guirefresh(10)  style("legacy") style("legacy")
...
<Cabbage>
form caption("Flooper2 File Player") size(805,340), colour(0,0,0) pluginid("FlFP") style("legacy") style("legacy")
