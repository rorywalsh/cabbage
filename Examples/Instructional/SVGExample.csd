...
rslider bounds(18, 280, 90, 90) channel("Waveshape3") imgfile("Slider", "rslider.svg") imgfile("background", "rslider_background.svg"), range(0, 5, 0, 1, 1) trackercolour(255, 165, 0, 255) trackerthickness(.5),
 hslider bounds(150, 34, 323, 27), channel("vslider1"), imgfile("slider", "hslider.svg"), imgfile("background", "hslider_background.svg"), text("Param1"), range(0, 1, .5), trackercolour("orange"), textbox(1), gradient(0), trackerthickness(.2)
 hslider bounds(150, 64, 322, 27), channel("vslider2"), imgfile("slider", "hslider.svg"), imgfile("background", "hslider_background.svg"), text("Param2"), range(0, 1, .75), trackercolour("orange"), textbox(1), gradient(0), trackerthickness(.2)
 hslider bounds(150, 94, 322, 27), channel("vslider3"), imgfile("slider", "hslider.svg"), imgfile("background", "hslider_background.svg"), text("Param3"), range(0, 1, .25), trackercolour("orange"), textbox(1), gradient(0), trackerthickness(.2)
