...
gentable bounds(155, 27,200, 75), tableNumbers(1,2), tableColour:0(200,200,200), tableColour:1(200,200,200), identChannel("table"), fill(0), ampRange(0,1,-1), zoom(-1), tableGridColour(0,0,0,0), tableBackgroundColour(200,200,200), outlineThickness(2)
}
