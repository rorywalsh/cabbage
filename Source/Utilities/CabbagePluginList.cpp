...
bool CabbagePluginListComponent::canShowSelectedFolder() const
{
...
void CabbagePluginListComponent::showSelectedFolder()
{
...
void CabbagePluginListComponent::optionsMenuCallback (int result)
{
    switch (result)
    {
        case 0:   break;
