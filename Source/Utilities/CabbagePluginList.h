...
class CabbagePluginListComponent   : public Component,
...
public:
    ...
    */
    CabbagePluginListComponent (AudioPluginFormatManager& formatManager,
    ...
    /** Destructor. */
    ~CabbagePluginListComponent() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (CabbagePluginListComponent)
};