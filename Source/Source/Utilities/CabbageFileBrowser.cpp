...
#include "CabbageFileBrowser.h"

CabbageFileBrowserComponent::CabbageFileBrowserComponent (int flags_,
...
CabbageFileBrowserComponent::~CabbageFileBrowserComponent()
{
...
//==============================================================================
void CabbageFileBrowserComponent::addListener (FileBrowserListener* const newListener)
{
    listeners.add (newListener);
}

void CabbageFileBrowserComponent::removeListener (FileBrowserListener* const listener)
{
    listeners.remove (listener);
}

//==============================================================================
bool CabbageFileBrowserComponent::isSaveMode() const noexcept
{
    return (flags & saveMode) != 0;
}

int CabbageFileBrowserComponent::getNumSelectedFiles() const noexcept
{
...
File CabbageFileBrowserComponent::getSelectedFile (int index) const noexcept
{
...
bool CabbageFileBrowserComponent::currentFileIsValid() const
{
...
File CabbageFileBrowserComponent::getHighlightedFile() const noexcept
{
    return fileListComponent->getSelectedFile (0);
}

void CabbageFileBrowserComponent::deselectAllFiles()
{
    fileListComponent->deselectAllFiles();
}

//==============================================================================
bool CabbageFileBrowserComponent::isFileSuitable (const File& file) const
{
    return (flags & canSelectFiles) != 0
             && (fileFilter == nullptr || fileFilter->isFileSuitable (file));
}

bool CabbageFileBrowserComponent::isDirectorySuitable (const File&) const
{
    return true;
}

bool CabbageFileBrowserComponent::isFileOrDirSuitable (const File& f) const
{
    if (f.isDirectory())
...
//==============================================================================
const File& CabbageFileBrowserComponent::getRoot() const
{
    return currentRoot;
}

void CabbageFileBrowserComponent::setRoot (const File& newRootDirectory)
{
...
void CabbageFileBrowserComponent::setFileName (const String& newName)
{
...
void CabbageFileBrowserComponent::resetRecentPaths()
{
...
void CabbageFileBrowserComponent::goUp()
{
    setRoot (getRoot().getParentDirectory());
}

void CabbageFileBrowserComponent::refresh()
{
    fileList->refresh();
}

void CabbageFileBrowserComponent::setFileFilter (const FileFilter* const newFileFilter)
{
...
String CabbageFileBrowserComponent::getActionVerb() const
{
...
void CabbageFileBrowserComponent::setFilenameBoxLabel (const String& name)
{
    fileLabel.setText (name, dontSendNotification);
}

FilePreviewComponent* CabbageFileBrowserComponent::getPreviewComponent() const noexcept
{
    return previewComp;
}

DirectoryContentsDisplayComponent* CabbageFileBrowserComponent::getDisplayComponent() const noexcept
{
    return fileListComponent.get();
}

//==============================================================================
void CabbageFileBrowserComponent::resized()
{
//    getLookAndFeel()
...
//                                     &currentPathBox, &filenameBox, goUpButton.get());
    ...
    auto b = getLocalBounds().reduced (20, 5);
...
//==============================================================================
void CabbageFileBrowserComponent::lookAndFeelChanged()
{
...
//==============================================================================
void CabbageFileBrowserComponent::sendListenerChangeMessage()
{
    Component::BailOutChecker checker (this);
...
void CabbageFileBrowserComponent::selectionChanged()
{
...
void CabbageFileBrowserComponent::mouseDrag (const MouseEvent &e)
{
    startDragging(lastClickedFile, getComponentAt(componentPos.getX(), componentPos.getY()));
}


void CabbageFileBrowserComponent::fileClicked (const File& f, const MouseEvent& e)
{
    lastClickedFile = f.getFullPathName();
    componentPos = e.position;
    Component::BailOutChecker checker (this);
    listeners.callChecked (checker, [&] (FileBrowserListener& l) { l.fileClicked (f, e); });
}

void CabbageFileBrowserComponent::fileDoubleClicked (const File& f)
{
    if (f.isDirectory())
    {
        setRoot (f);
...
void CabbageFileBrowserComponent::browserRootChanged (const File&) {}

bool CabbageFileBrowserComponent::keyPressed (const KeyPress& key)
{
...
//==============================================================================
void CabbageFileBrowserComponent::changeFilename()
{
...
//==============================================================================
void CabbageFileBrowserComponent::updateSelectedPath()
{
...
void CabbageFileBrowserComponent::getDefaultRoots (StringArray& rootNames, StringArray& rootPaths)
{
   #if JUCE_WINDOWS
    Array<File> roots;
...
void CabbageFileBrowserComponent::getRoots (StringArray& rootNames, StringArray& rootPaths)
{
    getDefaultRoots (rootNames, rootPaths);
}

void CabbageFileBrowserComponent::timerCallback()
{
