...
class CabbageFileBrowserComponent  : public Component,
...
public:
    ...
    /** Various options for the browser.
        ...
        A combination of these is passed into the CabbageFileBrowserComponent constructor.
    */
    ...
    //==============================================================================
    /** Creates a CabbageFileBrowserComponent.
        ...
        @param fileFilter               an optional filter to use to determine which files are shown.
                                        ...
                                        before the CabbageFileBrowserComponent object is deleted.
        @param previewComp              an optional preview component that will be used to show previews of
                                        files that the user selects
    */
    CabbageFileBrowserComponent (int flags,
                          const File& initialFileOrDirectory,
                          const FileFilter* fileFilter,
                          FilePreviewComponent* previewComp);

    /** Destructor. */
    ~CabbageFileBrowserComponent() override;
    ...
    */
    struct JUCE_API  LookAndFeelMethods
    {
        ...
        virtual void layoutCabbageFileBrowserComponent (CabbageFileBrowserComponent& browserComp,
    ...
    /** A set of colour IDs to use to change the colour of various aspects of the CabbageFileBrowserComponent.
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (CabbageFileBrowserComponent)
};
