...
//    csnd::plugin<SetStateStringArrayData>((csnd::Csound*) getCsound()->GetCsound(), "cabbageSetStateValue.s", "", "SS[]", csnd::thread::i);
    ...
    csnd::plugin<GetCabbageValueWithTrigger>((csnd::Csound*) getCsound()->GetCsound(), "cabbageGetValue", "kk", "S", csnd::thread::ik);
    ...
    csnd::plugin<CabbageFileReader>((csnd::Csound*)getCsound()->GetCsound(), "cabbageFileReader", "aa", "Skii", csnd::thread::ia);
