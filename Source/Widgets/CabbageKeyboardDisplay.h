...
class CabbageKeyboardDisplay : public MidiKeyboardComponent, public ValueTree::Listener, public CabbageWidgetBase
{
	int scrollbars;
	float keyWidth;
	String kind;
...
public:
	...
	CabbageKeyboardDisplay(ValueTree wData, MidiKeyboardState& state);
