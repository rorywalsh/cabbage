...
private:
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MidiKeyboardDisplay)
};
...
class CabbageKeyboardDisplay : public MidiKeyboardDisplay, public ValueTree::Listener, public CabbageWidgetBase
{
	int scrollbars;
	float keyWidth;
	String kind;
