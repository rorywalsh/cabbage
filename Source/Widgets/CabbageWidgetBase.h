...
public:
	...
	const StringArray&  getChannelArray() const { 		return channelArray;	}
	const String&  getCsdFile() const {		return csdFile;	}
	float  getCurrentValue() const {		return currentValue;	}
	int  getPivotx() const {		return pivotx;	}
	int  getPivoty() const {		return pivoty;	}
	float  getRotate() const {		return rotate;	}
	const String&  getText() const {		return text;	}
	const StringArray&  getTextArray() const {		return textArray;	}
	const String&  getTooltipText() const {		return tooltipText;	}
	int  getValue() const {		return value;	}
	int  getVisible() const {		return visible;	}
	StringArray getTextArray() {		return textArray;	}
	StringArray getChannelArray() {		return channelArray;	}	
