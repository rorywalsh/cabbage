...
class CabbageXYPad : public XYPad, public ValueTree::Listener, public CabbageWidgetBase
{
	CabbagePluginEditor* owner;
public:

    CabbageXYPad(ValueTree wData, XYPadAutomation* xyAuto, CabbagePluginEditor* editor, int index);
    ~CabbageXYPad() {};
